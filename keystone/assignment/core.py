...
class Manager(manager.Manager):
    ...
    def get_roles_for_user_and_project(self, user_id, tenant_id):
        ...
        def _get_group_project_roles(user_id, project_ref):
            ...
            # from a parent project. There is no need to support it on
            # other backend because get_roles_for_user_and_project will
            # be replaced by list_role_assignments filtered by user and
            # user in effective mode.
        ...
        def _user_project_roles(user_id, project_id):
            ...
            # Inherited roles are also considered for projects
            role_list += self._roles_from_role_dicts(
